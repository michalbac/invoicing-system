...
class TestHelpers {
    public static Company company1 = new Company(UUID.randomUUID(), "PL5201111333", "00-001 Warszawa, Francuska 1")
    public static Company company2 = new Company(UUID.randomUUID(), "PL5201111333", "00-001 Warszawa, Prosta 7")
    public static InvoiceEntry entry1 = new InvoiceEntry("bread", 2.0, 0.46, Vat.STANDARD)
    public static InvoiceEntry entry2 = new InvoiceEntry("milk", 3.0, 0.24, Vat.REDUCED)
